...
namespace ForStartingApp
{
    ...
    {
        public static string _Path = @"C:\TEMP\Path.xml";


        public static void Save(ApplicationXML applicationXML)
        {
        ...
        public static void Modify(ApplicationXML savePathXML, string type)
        {
            XmlDocument xdoc = new XmlDocument();
            xdoc.Load(_Path);
